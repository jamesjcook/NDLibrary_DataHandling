...
my ($ptxt,$version,$LibName);
{
    ...
    print("Loaded ".scalar(@fa)." lines of $source_branch/lib.conf\n");
    chomp(@fa);
...
#Use of uninitialized value within @vars in split at ./rat2019_bundling.pl line 402.
#Use of uninitialized value within @vars in string eq at ./rat2019_bundling.pl line 417.
#Undefined subroutine &main::write_array_to_file called at ./rat2019_bundling.pl line 422.
